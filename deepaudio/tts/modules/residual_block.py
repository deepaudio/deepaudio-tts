...
from deepaudio.tts.modules.activation import get_activation
    ...
    def __init__(self,
        ...
        if aux_channels is not None:
            self.conv1x1_aux = nn.Conv1d(
                aux_channels, gate_channels, kernel_size=1, bias=False)
        else:
            self.conv1x1_aux = None

        gate_out_channels = gate_channels // 2
        self.conv1x1_out = nn.Conv1d(
            gate_out_channels, residual_channels, kernel_size=1, bias=bias)
        self.conv1x1_skip = nn.Conv1d(
            gate_out_channels, skip_channels, kernel_size=1, bias=bias)
